...
function __wbg_adapter_289(arg0, arg1, arg2, arg3) {
    wasm.closure2799_externref_shim(arg0, arg1, arg2, arg3);
}
...
const Cifar10ModelFinalization = (typeof FinalizationRegistry === 'undefined')
    ? { register: () => {}, unregister: () => {} }
    : new FinalizationRegistry(ptr => wasm.__wbg_cifar10model_free(ptr >>> 0, 1));
/**
 * CIFAR-10専用の推論クラス
 */
export class Cifar10Model {

    __destroy_into_raw() {
        const ptr = this.__wbg_ptr;
        this.__wbg_ptr = 0;
        Cifar10ModelFinalization.unregister(this);
        return ptr;
    }

    free() {
        const ptr = this.__destroy_into_raw();
        wasm.__wbg_cifar10model_free(ptr, 0);
    }
    /**
     * コンストラクタ
     */
    constructor() {
        const ret = wasm.cifar10model_new();
        this.__wbg_ptr = ret >>> 0;
        Cifar10ModelFinalization.register(this, this.__wbg_ptr, this);
        return this;
    }
    /**
     * モデルをロード
     ...
     */
    load() {
        const ret = wasm.cifar10model_load(this.__wbg_ptr);
        return ret;
    }
    /**
     * 推論実行（確率配列を返す）
    ...
    inference(input) {
        ...
        const ret = wasm.cifar10model_inference(this.__wbg_ptr, ptr0, len0);
        return ret;
    }
    /**
     * Top-1予測クラスのみ返す
    ...
    inferenceTop1(input) {
        const ptr0 = passArrayF32ToWasm0(input, wasm.__wbindgen_malloc);
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.cifar10model_inferenceTop1(this.__wbg_ptr, ptr0, len0);
        return ret;
    }
    /**
     * 予測クラス名を返す
    ...
    getClassName(class_id) {
        ...
        let deferred1_1;
        try {
            const ret = wasm.cifar10model_getClassName(this.__wbg_ptr, class_id);
            deferred1_0 = ret[0];
            deferred1_1 = ret[1];
     ...
     */
    isLoaded() {
        const ret = wasm.cifar10model_isLoaded(this.__wbg_ptr);
        return ret !== 0;
    }
    /**
     * クラス一覧を返す
     ...
     */
    getClassNames() {
        const ret = wasm.cifar10model_getClassNames(this.__wbg_ptr);
        return ret;
    }
}
if (Symbol.dispose) Cifar10Model.prototype[Symbol.dispose] = Cifar10Model.prototype.free;
...
function __wbg_get_imports() {
    ...
    imports.wbg.__wbindgen_cast_02eb21a22829f2a8 = function(arg0, arg1) {
        // Cast intrinsic for `Closure(Closure { dtor_idx: 2786, function: Function { arguments: [Externref], shim_idx: 2787, ret: Unit, inner_ret: Some(Unit) }, mutable: true }) -> Externref`.
        const ret = makeMutClosure(arg0, arg1, 2786, __wbg_adapter_6);
        return ret;
    };
...
async function __wbg_init(module_or_path) {
    ...
    if (typeof module_or_path === 'undefined') {
        module_or_path = new URL('lab_vision_burn_model_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
