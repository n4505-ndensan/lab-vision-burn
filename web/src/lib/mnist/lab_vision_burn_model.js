...
function __wbg_adapter_287(arg0, arg1, arg2, arg3) {
    wasm.closure2815_externref_shim(arg0, arg1, arg2, arg3);
}
...
const MnistModelFinalization = (typeof FinalizationRegistry === 'undefined')
    ? { register: () => {}, unregister: () => {} }
    : new FinalizationRegistry(ptr => wasm.__wbg_mnistmodel_free(ptr >>> 0, 1));
/**
 * MNIST専用の推論クラス
 */
export class MnistModel {
    ...
    __destroy_into_raw() {
        ...
        this.__wbg_ptr = 0;
        MnistModelFinalization.unregister(this);
        return ptr;
    }

    free() {
        const ptr = this.__destroy_into_raw();
        wasm.__wbg_mnistmodel_free(ptr, 0);
    }
    /**
     * コンストラクタ
     */
    constructor() {
        const ret = wasm.mnistmodel_new();
        this.__wbg_ptr = ret >>> 0;
        MnistModelFinalization.register(this, this.__wbg_ptr, this);
        return this;
    }
    /**
     * モデルをロード
     ...
     */
    load() {
        const ret = wasm.mnistmodel_load(this.__wbg_ptr);
        return ret;
    }
    /**
     * 推論実行（確率配列を返す）
    ...
    inference(input) {
        ...
        const ret = wasm.mnistmodel_inference(this.__wbg_ptr, ptr0, len0);
        return ret;
    }
    /**
     * Top-1予測クラスのみ返す
    ...
    inferenceTop1(input) {
        const ptr0 = passArrayF32ToWasm0(input, wasm.__wbindgen_malloc);
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.mnistmodel_inferenceTop1(this.__wbg_ptr, ptr0, len0);
        return ret;
    }
    /**
     * モデルがロード済みか確認
     ...
     */
    isLoaded() {
        const ret = wasm.mnistmodel_isLoaded(this.__wbg_ptr);
        return ret !== 0;
    }
}
if (Symbol.dispose) MnistModel.prototype[Symbol.dispose] = MnistModel.prototype.free;
...
function __wbg_get_imports() {
    ...
    imports.wbg.__wbindgen_cast_19db0952d03c92b2 = function(arg0, arg1) {
        // Cast intrinsic for `Closure(Closure { dtor_idx: 2802, function: Function { arguments: [Externref], shim_idx: 2803, ret: Unit, inner_ret: Some(Unit) }, mutable: true }) -> Externref`.
        const ret = makeMutClosure(arg0, arg1, 2802, __wbg_adapter_6);
        return ret;
    };
