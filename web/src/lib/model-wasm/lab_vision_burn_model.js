...
function __wbg_adapter_12(arg0, arg1, arg2) {
    wasm.closure2793_externref_shim(arg0, arg1, arg2);
}
...
export class Mnist {
     ...
     */
    load() {
        const ret = wasm.mnist_load(this.__wbg_ptr);
        return ret;
    }
    /**
     * モデルがロード済みか
     ...
     */
    isLoaded() {
        const ret = wasm.mnist_isLoaded(this.__wbg_ptr);
        return ret !== 0;
    }
    /**
    ...
    inferenceTop1(input) {
        const ptr0 = passArrayF32ToWasm0(input, wasm.__wbindgen_malloc);
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.mnist_inferenceTop1(this.__wbg_ptr, ptr0, len0);
        return ret;
    }
}
if (Symbol.dispose) Mnist.prototype[Symbol.dispose] = Mnist.prototype.free;
...
function __wbg_get_imports() {
    ...
    imports.wbg.__wbindgen_cast_341de2f879ca9957 = function(arg0, arg1) {
        // Cast intrinsic for `Closure(Closure { dtor_idx: 2792, function: Function { arguments: [Externref], shim_idx: 2793, ret: Unit, inner_ret: Some(Unit) }, mutable: true }) -> Externref`.
        const ret = makeMutClosure(arg0, arg1, 2792, __wbg_adapter_12);
        return ret;
    };
